# Generated by Django 4.2 on 2024-12-01 12:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefghijklmnp12345', length=10, max_length=10, prefix='', unique=True)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.product')),
            ],
        ),
        migrations.CreateModel(
